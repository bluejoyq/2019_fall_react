...
class SearchBar extends React.Component {
  ...
  handleChangeDo = (elem) => {
    ...
    this.props.changeSearch({do:select,gu:this.state.gu,keyword:this.state.keyword})
  }

  handleChangeGu = (elem) => {
      let select = elem.target.value;
      this.setState({gu : select});
      this.props.changeSearch({do:this.state.do,gu:select,keyword:this.state.keyword})
  }

  handleChangeInput = (elem) => {
    let input = elem.target.value;
    this.setState({keyword : input});
    this.props.changeSearch({do:this.state.do,gu:this.state.gu,keyword:input})
  }
