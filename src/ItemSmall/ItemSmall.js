        ...
        return(
            <div className ='Small'>
                ...
                : null
                    ...
                    <div className={Math.max(document.documentElement.clientWidth, window.innerWidth || 0)<800 ? 
                    "mobileItemSmall":"desktopItemSmall"} onClick={this.props.openPopup(this.props.item._id)}>
                    <div className='smallInfo'>
                        <span className='userInfo'>
                            ...
                            <div className='itemSmallLocation'>
                                {this.props.item.location}<br/>{this.props.item.subLocation}
                            </div>
                            
                        </span>
                        <div className='itemSmallInfo'  onClick={this.toggleItem}>
...
export default withStyles(styles, { withTheme: true })(ItemSmall);